#modname "Improved Casting AI CBM v0.1"
#description "A mod to improve offscript casting AI especially in assassinations. Disables offscript casting of ALL buffs. Deprioritizes certain bad spells that the AI casts in CBM. Prioritizes good spells for the AI to cast."
...
#aispellmod -50 -- Ok but pretty bad compared to other fire magic
#end
